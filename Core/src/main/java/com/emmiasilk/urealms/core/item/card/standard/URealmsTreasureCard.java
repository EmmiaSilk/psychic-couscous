...
import com.emmiasilk.urealms.api.item.card.standard.TreasureCard;

import java.util.Collection;
import java.util.HashSet;

public class URealmsTreasureCard extends URealmsStandardCard implements TreasureCard {

    private int gold;
    private Collection<ElementType> elements;
    private Collection<Gem> gems;

    public URealmsTreasureCard(String name, int gold, Collection<? extends Gem> gems,
