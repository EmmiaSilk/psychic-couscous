...
import com.emmiasilk.urealms.api.item.card.standard.ClassAbilityCard;

import java.util.Collection;
import java.util.HashSet;

public class URealmsClassAbilityCard extends URealmsStandardCard implements ClassAbilityCard {

    private int gold;
    private Collection<ElementType> elements;
    private Collection<Gem> gems;

    public URealmsClassAbilityCard(String name, int gold, Collection<? extends Gem> gems,
